...
import org.peekmoon.kafkui.action.ExitAction;
import org.peekmoon.kafkui.action.VoidAction;
import org.peekmoon.kafkui.configuration.ClusterConfiguration;
import org.peekmoon.kafkui.configuration.Configuration;
import org.peekmoon.kafkui.tui.*;
import org.peekmoon.kafkui.utils.LogInitializer;
import org.peekmoon.kafkui.utils.UncaughtExceptionHandler;
...
public class Application  {
    ...
    public void run() {
        ...
        if (!Configuration.fileExists()) {
            System.err.println("A file " + Configuration.getConfigFile() + " should exists and be readable");
            System.exit(-1);
        }
        if (!Configuration.canRead()) {
            System.err.println("Unable to read file " + Configuration.getConfigFile());
            System.exit(-1);
        }
