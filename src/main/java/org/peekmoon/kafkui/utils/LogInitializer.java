package org.peekmoon.kafkui.utils;
...
public class LogInitializer {
    ...
    public static void init() {
        ...
        if (logDirectory == null) {
            ...
            String logFile = logDirectory + "/kafkui.log";
            try {
                ...
                logHandler.setFormatter(new kafkuiFormatter());
    ...
    static class kafkuiFormatter extends Formatter {
